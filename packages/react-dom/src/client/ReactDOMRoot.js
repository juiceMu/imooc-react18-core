 ...
 * 这个构造函数用于创建ReactDOMRoot实例对象，实例对象中包含一个_internalRoot属性，该属性引用了React Fiber树的根节点
 */
 ...
 * createRoot是一个工厂函数，接受一个DOM元素作为参数，这个DOM元素通常是React应用的根DOM节点
 * 在函数内部，首先通过调用createContainer函数，传入DOM元素参数，创建一个Fiber根节点
 * 然后将这个Fiber根节点传入ReactDOMRoot构造函数，创建一个ReactDOMRoot示例对象，并返回
 */
